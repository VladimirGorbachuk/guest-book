...
SECRET_KEY = 'xfw&upb$4!7%!+01w$+1739)-%i9wae#&f(yjiw88iti8t+xjs'
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware', #for protection against csrf and successful working with frontend request
